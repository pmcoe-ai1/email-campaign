...
.intro-modern{background:#f8f9fa;border-radius:12px;padding:24px;margin-bottom:24px;border-left:4px solid #e94560;text-align:center}.intro-modern h2{color:#1a1a2e;font-size:1.4rem;margin-bottom:8px}.intro-modern .subhead{color:#6c757d;margin-bottom:16px}.intro-modern .price{font-size:2.5rem;font-weight:700;color:#e94560;margin:16px 0 4px}.intro-modern .price-caption{color:#6c757d;font-size:0.9rem;margin-bottom:20px}.intro-modern .benefit{display:flex;align-items:flex-start;padding:12px 0;border-top:1px solid #e9ecef;text-align:left}.intro-modern .benefit:first-of-type{border-top:none}.intro-modern .benefit-title{font-weight:600;color:#1a1a2e}.intro-modern .benefit-badge{font-size:0.7rem;padding:2px 8px;border-radius:10px;margin-left:8px;font-weight:600}.intro-modern .benefit-badge.free{background:#d4edda;color:#155724}.intro-modern .benefit-badge.earn{background:#fff3cd;color:#856404}.intro-modern .benefit-badge.discount{background:#cce5ff;color:#004085}.intro-modern .benefit-desc{color:#6c757d;font-size:0.85rem;margin-top:4px}
